...
public class DoctorFXMLController implements Initializable {
    ...
    @FXML
    private void appointmentApprovalAction(ActionEvent event) throws IOException {
        Parent pane = FXMLLoader.load(getClass().getResource("ApproveAppointmentFXML.fxml"));
        bp.setCenter(pane);
    }
    
    @FXML
    private void askDayOffAction(ActionEvent event) throws IOException {
        Parent pane = FXMLLoader.load(getClass().getResource("AskDayOffFXML.fxml"));
        bp.setCenter(pane);
    }
